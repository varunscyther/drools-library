...
public class VerifyExistsKeywordBehaviour {
    public static void main(String[] args) {

        // Fixed the groupRule problem i.e Rule fired multiple time for one invalid passport
        System.out.println( "Bootstrapping the Rule Engine ..." );
        KieServices ks = KieServices.Factory.get();
        KieContainer kContainer = ks.getKieClasspathContainer();
        KieSession kSession =  kContainer.newKieSession("existsRule-session");
        ...
        List<FamilyVisaApplication> familyVisaApplications = DataRepository.getFamilyVisaApplication();
